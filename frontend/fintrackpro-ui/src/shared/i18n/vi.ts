const vi = {
  ...
  dashboard: {
    ...
    openPositions: '{{count}} vị thế đang mở',
    invested: 'Đã đầu tư',
    noOpenPositions: 'Không có vị thế mở',
    expenseAllocation: 'Phân bổ chi tiêu',
    noExpensesThisMonth: 'Chưa có chi tiêu tháng này',
    addTransaction: 'Thêm giao dịch',
    moreCategories: 'danh mục khác',
    budgetHealth: 'Tình trạng ngân sách',
    noBudgetsSet: 'Chưa có ngân sách',
    ...
    losing: 'Đang lỗ',
    viewAll: 'Xem tất cả',
    noClosedTradesThisMonth: 'Không có giao dịch đóng tháng này',
    realisedPnl: 'Lãi/Lỗ đã chốt',
    winRate: 'Tỉ lệ thắng',
    avgPnlPerTrade: 'Lãi/Lỗ TB / lệnh',
    cumulativePnl: 'Lãi/Lỗ luỹ kế',
    bySymbol: 'Theo mã',
    byDirection: 'Theo chiều lệnh',
    avgWin: 'Lãi TB',
    avgLoss: 'Lỗ TB',
    closedTrades: 'Giao dịch đã đóng',
    recentActivity: 'Hoạt động gần đây',
    noRecentActivity: 'Chưa có hoạt động nào',
    signalsForWatchlist: 'Tín hiệu cho danh sách theo dõi',
    manageWatchlist: 'Quản lý danh sách',
  },
  transactions: {
    title: 'Thu chi',
    addTransaction: 'Thêm giao dịch',
