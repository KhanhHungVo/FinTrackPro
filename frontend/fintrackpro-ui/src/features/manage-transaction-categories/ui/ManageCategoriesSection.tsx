    ...
    <>
      <div className="rounded-xl border border-gray-200 bg-white p-4">
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            <p className="text-sm font-semibold text-gray-800">{t('settings.myCategories')}</p>
            <p className="text-xs text-gray-400 mt-0.5">{t('settings.myCategoriesHint')}</p>
          </div>
          <button
            type="button"
            onClick={openCreate}
        ...
        {!isLoading && userCategories.length > 0 && (
          <div className="space-y-2">
            {userCategories.map((cat) => (
              <div
                key={cat.id}
                className="flex items-center gap-3 rounded-lg border border-gray-100 bg-white px-3 py-2.5 hover:shadow-sm transition-shadow"
              >
                ...
                <div className="flex gap-1 shrink-0">
                  <button
                    ...
                    className="flex items-center gap-1 rounded px-2 py-1 text-xs font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 transition-colors"
                  >
                    <svg
                      width="12"
                      height="12"
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 rounded px-2 py-1 text-xs font-medium text-gray-500 hover:text-red-600 hover:bg-red-50 transition-colors"
                  >
                    <svg
                      width="12"
                      height="12"
