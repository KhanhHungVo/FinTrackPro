...
> For how auth works (flows, provider comparison, switching providers), see [docs/architecture/auth.md](../architecture/auth.md).
...
- [Render Deployment — Allowed URLs](#render-deployment--allowed-urls)
