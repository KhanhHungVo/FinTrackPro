...
public class TransactionConfiguration : IEntityTypeConfiguration<Transaction>
{
    public void Configure(EntityTypeBuilder<Transaction> builder)
    {
        ...
        builder.Property(t => t.CreatedAt).IsRequired().HasDefaultValueSql("NOW()").ValueGeneratedNever();
        builder.Property(t => t.UpdatedAt).IsRequired().HasDefaultValueSql("NOW()").ValueGeneratedNever();
